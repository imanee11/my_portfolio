        ...
        <>
            <div className='font-syne flex flex-col md:h-screen md:pt-[30vh]' >
                ...
                <div className='pt-5 flex flex-col md:flex-row md:justify-between md:items-center'>
                    <button className='w-full sm:w-auto flex items-center justify-center gap-2 md:border md:bg-none md:dark:bg-none md:border-[#c4cad8] md:text-[#22232C] text-[#E9E9F1] md:dark:text-[#E9E9F1] md:dark:border-[#4a4a4f] font-bold rounded-3xl px-4 py-3 hover:scale-105 transition-transform duration-300 bg-gradient-to-r from-[#aa70e0] to-[#7059e2] dark:bg-gradient-to-r dark:from-[#E4B8BF] dark:to-[#CEC4EF] dark:text-[#22232c]'>
